...
const Home = () => {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between p-10 md:py-20">
          <div className="md:w-1/2 space-y-6 text-center md:text-left">
            <h1 className="text-5xl font-extrabold leading-tight">
              Join Events that <br />{" "}
              <span className="text-yellow-300">Make the World Better</span>
            </h1>
            <p className="text-lg text-blue-100">
              Connect, contribute, and create positive change through community
              events.
            </p>
            <Link to="/upcoming">
          ...
          <div className="md:w-1/2 mt-10 md:mt-0">
            <img
              src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixlib=rb-4.0.3&w=1000&q=80"
              alt="Community Event"
          ...
          {[
            {
              ...
              text: "Create and manage impactful events effortlessly with our user-friendly interface.",
            },
            {
              icon: <FaUsers />,
              title: "Community Building",
              text: "Connect with like-minded individuals working for environmental and social good.",
            },
            {
              icon: <FaLeaf />,
              title: "Sustainability Focused",
              text: "All our events promote sustainability and community well-being.",
            },
            {
              icon: <FaHandsHelping />,
              title: "Volunteer Opportunities",
              text: "Join hands in making a difference through organized volunteering events.",
            },
          ].map((item, index) => (
            <div
              key={index}
              className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all"
            >
              <div className="text-green-600 dark:text-green-400 text-4xl mb-4 mx-auto">
                {item.icon}
              </div>
      ...
      {/* Vision Section */}
      <section className="py-16 md:py-24 bg-white dark:bg-gray-800 transition">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:pr-12">
              ...
              <h2 className="text-5xl md:text-6xl font-extrabold text-gray-900 dark:text-gray-100 leading-tight mb-8">
                Make a Better Bangladesh
              </h2>
              <p className="mt-4 text-gray-600 dark:text-gray-300 text-lg leading-relaxed mb-8">
                Our vision is to build a cleaner and greener Bangladesh by
                inspiring people to take part in cleaning activities and
      ...
      <section className="bg-gradient-to-r from-green-500 to-blue-600 text-white py-16 px-6">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="text-lg text-blue-100">
            Join our newsletter to get the latest updates on upcoming events and
            opportunities.
          </p>
        </div>
      </section>
