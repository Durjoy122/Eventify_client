...
const BASE_URL = "https://eventify-server-sigma.vercel.app";
...
const ManageEvents = () => {
  ...
  const handleDelete = async (id) => {
    ...
    if (confirm.isConfirmed) {
      try {
        await axios.delete(`${BASE_URL}/events/${id}?userEmail=${user.email}`);
  ...
  return (
    <div className="min-h-screen p-6 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <dialog
        id="edit_modal"
        className="modal modal-bottom sm:modal-middle dark:bg-gray-900 dark:text-gray-100"
      >
