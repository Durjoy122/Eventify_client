...
const JoinEvent = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6 transition-colors duration-300"> {/* Dark bg added */}
            <h2 className="text-2xl font-semibold text-center mb-6 text-gray-900 dark:text-gray-100">My Joined Events</h2> {/* Dark text */}
            
            {joinedEvents.length === 0 ? (
                <p className="text-center text-gray-600 dark:text-gray-300">You haven’t joined any events yet.</p>
            ) : (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 p-4">
                    {joinedEvents.map((event) => (
                        <div
                            key={event._id}
                            className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-xl dark:shadow-lg rounded-xl overflow-hidden flex flex-col transform hover:scale-[1.02] transition duration-300 ease-in-out hover:shadow-2xl"
                        >
                            ...
                            <div className="p-5 flex-1 flex flex-col">
                                ...
                                <hr className="my-3 border-gray-100 dark:border-gray-700" /> {/* Dark border */}

                                <p className="text-xs text-gray-500 dark:text-gray-300 mt-auto pt-2">
